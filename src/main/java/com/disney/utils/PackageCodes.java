	...
	public String retrievePackageCode(String environment, String arrivalDate, 
		...
		sql = "SELECT DISTINCT(PKG.PKG_CD)" +   
				  ...
				  " WHERE PKG.SALES_CHANNEL = '"  + packageType +"' "  +  
						...
						" AND ACMPROD_PKG.VISIBILITY = 'SELLABLE' " +  
...
//	}
	...
	public void takePackageCodes(String environment,String packageBillCode,String resortCode,String roomCode,String scenario){
		Reservation reservation = new GenerateReservation()
		.bookResortReservation().CONTEMPORARY(environment);
		...
		retrievePackageCode(environment,
				reservation.getArrivalDaysOut(),
				reservation.getDepartureDaysOut(), packageType,
				packageBillCode, resortCode, roomCode, packageDeascription);	
