...
import com.disney.api.soapServices.__OLD__eventDiningService.operations.NoShow;
...
public class EventDiningReservation implements ScheduledEventReservation {
	...
	private class ModifyEventDining implements Modify{
		 ...
		 */
		private void modify(){
			com.disney.api.soapServices.__OLD__eventDiningService.operations.Modify modify = new com.disney.api.soapServices.__OLD__eventDiningService.operations.Modify(getEnvironment(), modifyScenario);
