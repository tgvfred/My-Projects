...
public class SaratogaSprings extends ReservationDecorator implements Reservation{
	private int reservations;

	private void setResortInfo(){
		setLocationId(ResortColumns.MINI_CAMPUS, "Disney's Saratoga Springs Resort & Spa");
		setResortCode(ResortColumns.MINI_CAMPUS, "Disney's Saratoga Springs Resort & Spa");
		setFacilityId(ResortColumns.MINI_CAMPUS, "Disney's Saratoga Springs Resort & Spa");
		setSouceAccountingCenterId(ResortColumns.MINI_CAMPUS, "Disney's Saratoga Springs Resort & Spa");
		setRoomTypeCode("KB");
	}	
	
	public SaratogaSprings (String environment){
		super(environment);
		this.reservations = 1;
		setResortInfo();
	}
	
	public SaratogaSprings (String environment, int reservations){
		super(environment);
		this.reservations = reservations;
		setResortInfo();
	}
	
	public SaratogaSprings (String environment, String reservations){
		super(environment);
