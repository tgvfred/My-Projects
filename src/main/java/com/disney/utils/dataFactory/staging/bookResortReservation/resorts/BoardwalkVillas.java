...
public class BoardwalkVillas extends ReservationDecorator implements Reservation{
	private int reservations;

	private void setResortInfo(){
		setLocationId(ResortColumns.MINI_CAMPUS, "Disney's BoardWalk Villas");
		setResortCode(ResortColumns.MINI_CAMPUS, "Disney's BoardWalk Villas");
		setFacilityId(ResortColumns.MINI_CAMPUS, "Disney's BoardWalk Villas");
		setSouceAccountingCenterId(ResortColumns.MINI_CAMPUS, "Disney's BoardWalk Villas");
		setRoomTypeCode("ZB");
	}
	
	public BoardwalkVillas (String environment){
		super(environment);
		this.reservations = 1;
		setResortInfo();
	}
	
	public BoardwalkVillas (String environment, int reservations){
		super(environment);
		this.reservations = reservations;
		setResortInfo();
	}
	
	public BoardwalkVillas (String environment, String reservations){
		super(environment);
