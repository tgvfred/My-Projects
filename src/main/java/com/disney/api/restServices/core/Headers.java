...
public class Headers {
	...
	/*  private Header[] getHeaders(){
	  ...
	  public static Header[]  createHeader(HeaderType type)  {
		  Header[] headers = null;
		  String zddHeader = System.getenv("header");
		  if(zddHeader == null) zddHeader = System.getProperty("header");
		  if(zddHeader != null) {				
			  zddHeader = zddHeader.equalsIgnoreCase("Dark") ? "SHADOW" : zddHeader;
			  zddHeader = zddHeader.equalsIgnoreCase("Shadow") ? "SHADOW" : "";

			  if(zddHeader.equals("SHADOW")) TestReporter.logInfo("Request will be sent to Dark Side");
			  else TestReporter.logInfo("Request will be sent to Light Side");
		  }
		  else {
			  TestReporter.logInfo("Request will be sent to Light Side");
			  zddHeader = "";
		  }
		  ...
		  case JENKINS:		        	
			  ...
			  headers = new Header[] {
					  ...
					  new BasicHeader("X-Disney-Internal-PoolOverride",zddHeader)
					  };
			  break;
		  case AUTH:		        	
