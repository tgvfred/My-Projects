...
public class CreateOrganization extends OrganizationServiceV2{
	public CreateOrganization(String environment, String scenario) {
		super(environment);
		//Generate a request from a project xml file
		setRequestDocument(XMLTools.loadXML(buildRequestFromWSDL("createOrganization")));
	...
	public boolean validateResponse(String scenario){
		//return validateResponse("/services/organizationServiceV2/createOrganization/createOrganizationResponse.xls", scenario);
		return validateResponse("OrganizationServiceV2", getOperation(), scenario);
	}
