...
public class UpdateInventoryForScheduledEvents extends AccommodationInventoryRequestComponentServicePort{
	 ...
	 * @param index - node index for which to set the parent owner reference type
	 */
	public void setOwnerDetailsParentOwnerReferenceType(String value, String index){setRequestNodeValueByXPath("/Envelope/Body/updateInventoryForScheduledEvents/request/newAssignmentOwners/ownerDetails/parentOwnerReferences["+index+"]/ownerReferenceType", value);}
	/**
	 * Sets owner details parent owner reference number
	 * @param value - owner details parent owner reference number 
	 * @param index - node index for which to set the parent owner reference number
	 */
	public void setOwnerDetailsParentOwnerReferenceNumber(String value, String index){setRequestNodeValueByXPath("/Envelope/Body/updateInventoryForScheduledEvents/request/newAssignmentOwners/ownerDetails/parentOwnerReferences["+index+"]/referenceNumber", value);}
	/**
