...
public class Book extends AccommodationSalesServicePort {
    ...
    public Book(String environment, String scenario) {
        ...
        // setRequestNodeValueByXPath(getTestScenario("/services/accommodationSalesServicePort/book/bookInput.xls",
        // scenario));
    ...
    /**
     *
     * @summary Method to set the request departure date - modified to handle 2
     *          scenarios
     *          1) a string-number is passed as the days out (EX: "0")
     *          2) a string-function is passed as the days out (EX:
     *          "fx:GetDate; Daysout:0")
     * @version Created 11/11/2014
     * @author Waightstill W Avery
     * @param deptDateDaysOut
     *            - string used to define the days out in the request; see
    ...
    /**
     *
     * @summary Method to set the request arrival date - modified to handle 2
     *          scenarios
     *          1) a string-number is passed as the days out (EX: "0")
     *          2) a string-function is passed as the days out (EX:
     *          "fx:GetDate; Daysout:0")
     ...
     * @param commentText
     * @param routing
     *            AutoFulfillment / Celebrations / Dispatch System / Guest
     *            History / Guest Recovery / Guest Request / HouseKeeping /
     *            Inventory / Reservation / Reservation and Confirmation /
     *            Resort Call Center / SE SPL Needs / SPL Event
     */
    ...
    // Guest first & last names. Have to enter in 2 places, under the Guest
    // reference details node & the travel plan guest node
    ...
    public void setPrimaryGuestMiddleNameGuestRefDetails(String middleName) {
        try {
            setRequestNodeValueByXPath("//book/request/roomDetail/roomReservationDetail/guestReferenceDetails/guest/middleName", middleName);
        } catch (XPathNotFoundException e) {
            setRequestNodeValueByXPath("//book/request/roomDetail/roomReservationDetail/guestReferenceDetails/guest", BaseSoapCommands.ADD_NODE.commandAppend("middleName"));
            setRequestNodeValueByXPath("//book/request/roomDetail/roomReservationDetail/guestReferenceDetails/guest/middleName", middleName);
        }
    }
    ...
    public void setPrimaryGuestMiddleNameTravelPlan(String middleName) {
        try {
            setRequestNodeValueByXPath("//book/request/travelPlanGuest/middleName", middleName);
        } catch (XPathNotFoundException e) {
            setRequestNodeValueByXPath("//book/request/travelPlanGuest", BaseSoapCommands.ADD_NODE.commandAppend("middleName"));
            setRequestNodeValueByXPath("//book/request/travelPlanGuest/middleName", middleName);
        }
    }
    ...
    public void setPrimaryGuestMiddleName(String middleName) {
        try {
            setRequestNodeValueByXPath("//guest/middleName", middleName);
        } catch (XPathNotFoundException e) {
            setRequestNodeValueByXPath("//guest", BaseSoapCommands.ADD_NODE.commandAppend("middleName"));
            setRequestNodeValueByXPath("//guest/middleName", middleName);
        }
        try {
            setRequestNodeValueByXPath("//travelPlanGuest/middleName", middleName);
        } catch (XPathNotFoundException e) {
            setRequestNodeValueByXPath("//travelPlanGuest", BaseSoapCommands.ADD_NODE.commandAppend("middleName"));
            setRequestNodeValueByXPath("//travelPlanGuest/middleName", middleName);
        }
