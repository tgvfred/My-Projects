...
public class RetrieveRates extends AccommodationSalesServicePort {
    ...
    public String getRackRateDate(int index) {
        return getResponseNodeValueByXPath("/Envelope/Body/retrieveRatesResponse/accomodationRatesDetail/ratedetails[" + index + "]/rackRate/date");
    }

    public String getRackRateDate(String index) {
        return getRackRateDate(Integer.parseInt(index));
    }
 ...
 * public String getAccommodationRateDetails(String index) {return
 * getResponseNodeValueByXPath("/Envelope/Body/retrieveRatesResponse/accomodationRatesDetail["+index+"]");}
 ...
 * public String getRateDetails(String index) {return
 * getResponseNodeValueByXPath("/Envelope/Body/retrieveRatesResponse/accomodationRatesDetail/ratedetails["+index+"]");}
 ...
 * int currentNodes = 3;
 * try{currentNodes = XMLTools.getNodeList(getRequestDocument(),
 * "/Envelope/Body/retrieveRatesResponse/accomodationRatesDetail/ratedetails/rackRate").getLength();}
 * catch(XPathNotFoundException e){}
