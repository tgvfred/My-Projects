...
//	}
	...
	public void setBookingDate(String value) {
		try{setRequestNodeValueByXPath("/Envelope/Body/searchPackage/request/bookingDate", value);}
	...
	public void setPackageCode(String value) {
		try{setRequestNodeValueByXPath("/Envelope/Body/searchPackage/request/code", value);}
		catch(XPathNotFoundException e){
	...
	public void setPackageDescription(String value) {
		try{setRequestNodeValueByXPath("/Envelope/Body/searchPackage/request/description", value);}
		catch(XPathNotFoundException e){
	...
	public void setResortArrivalDate(String value) {
		try{setRequestNodeValueByXPath("/Envelope/Body/searchPackage/request/resortArrivalDate", value);}
		catch(XPathNotFoundException e){
	...
	public void setSalesChannelIDs(String value) {
		try{setRequestNodeValueByXPath("/Envelope/Body/searchPackage/request/salesChannelIDs", value);}
		catch(XPathNotFoundException e){
