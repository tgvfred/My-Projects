...
public class AccommodationErrorCode {
    ...
    public static final ApplicationErrorCode DATA_NOT_FOUND_EXCEPTION = new ApplicationErrorCode(MODULE_NAME, 91443,
            " Data not found. ");
    public static final ApplicationErrorCode PARAMETERS_MISSING_EXCEPTION = new ApplicationErrorCode(MODULE_NAME, 7064,
            " Required parameters are missing ");

    public static final ApplicationErrorCode NO_ACCOMMODATION_COMPONENT_EXCEPTION = new ApplicationErrorCode(MODULE_NAME, 7177,
