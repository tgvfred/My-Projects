...
public class AccommodationErrorCode {
    ...
    // public static final ApplicationErrorCode COMMUNICATION_CHANNEL_REQUIRED = new ApplicationErrorCode(MOD_NAME, 7096,
    // "communication Channel is required");
    // public static final ApplicationErrorCode SALES_CHANNEL_REQUIRED = new ApplicationErrorCode(MOD_NAME, 7094,
    // "Sales Channel is required");
    // public static final ApplicationErrorCode PACKAGE_CODE_INVALID = new ApplicationErrorCode(MOD_NAME, 7104,
    // "Package Code is invalid");
    // public static final ApplicationErrorCode INVALID_ROOM_TYPE = new ApplicationErrorCode(MOD_NAME, 7105,
    // "Room Type is invalid");
    // public static final ApplicationErrorCode INVALID_RESORT_CODE = new ApplicationErrorCode(MOD_NAME, 7106,
    // "Resort Code is invalid");
    // public static final ApplicationErrorCode TRAVEL_PLAN_NOT_FOUND = new ApplicationErrorCode(MOD_NAME, 7007,
    // "TRAVEL_PLAN_NOT_FOUND");
    // public static final ApplicationErrorCode ROOM_DETAIL_MISSING = new ApplicationErrorCode(MOD_NAME, 7228,
    // "There should be at least one Room Detail");
    // public static final ApplicationErrorCode GUEST_REQUIRED = new ApplicationErrorCode(MOD_NAME, 7027,
    // "Guest is Required");
    // public static final ApplicationErrorCode TRAVEL_PLAN_GUEST_REQUIRED = new ApplicationErrorCode(MOD_NAME, 7026,
    // "Travel Plan Guest is required");
    // public static final ApplicationErrorCode INVALID_RESORT_PERIOD = new ApplicationErrorCode(MOD_NAME, 7107,
    // " Resort Period is invalid ");
    // public static final ApplicationErrorCode TRAVEL_STATUS_INVALID = new ApplicationErrorCode(MOD_NAME, 7110,
    // " Travel Status is invalid ");
    // public static final ApplicationErrorCode EXT_REF_REQUIRED = new ApplicationErrorCode(MOD_NAME, 7088,
    // "External Reference is required");
    // public static final ApplicationErrorCode INVALID_EXT_REF_DETAILS = new ApplicationErrorCode(MOD_NAME, 7092,
    // "Invalid External Reference Details");
    // public static final ApplicationErrorCode DIRECT_CONNECT_BOTH_FPLOSID_AND_FREEZEID_CANNOT_EXIST = new ApplicationErrorCode(MOD_NAME, 7216,
    // "FPLOSID AND FREEZEID CANNOT BE USED TOGETHER!");
    // public static final ApplicationErrorCode INVALID_GATHERING_DETAIL = new ApplicationErrorCode(MOD_NAME, 7156,
