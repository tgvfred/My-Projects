...
public class AccommodationErrorCode {
	...
	private static final String DVC_NAME = "DVC Sales";
	...
	public static final ApplicationErrorCode REQUEST_REQUIRED = new ApplicationErrorCode(MODULE_NAME, 8078,
			" Create Comments Request Invalid ");
	public static final ApplicationErrorCode FACILITY_ID_REQUIRED = new ApplicationErrorCode(DVC_NAME, 9025,
			" Enterprice Facility ID is Required ");
}