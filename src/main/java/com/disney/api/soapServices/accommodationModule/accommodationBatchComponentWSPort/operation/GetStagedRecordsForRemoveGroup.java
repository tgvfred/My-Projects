...
public class GetStagedRecordsForRemoveGroup extends AccommodationBatchComponentWSPort {
    ...
    public String getRoomTravelComponentGroupingID() {
        return tryGetResponseNodeValueByXPath("/Envelope/Body/getStagedRecordsForRemoveGroupResponse/return/travelComponentGroupingId");
    }

    public String getRoomTravelComponentGroupingID(String index) {
        return tryGetResponseNodeValueByXPath("/Envelope/Body/getStagedRecordsForRemoveGroupResponse/return[" + index + "]/travelComponentGroupingId");
    }
