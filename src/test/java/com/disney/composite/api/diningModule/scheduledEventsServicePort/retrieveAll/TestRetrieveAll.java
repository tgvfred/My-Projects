package com.disney.composite.api.diningModule.scheduledEventsServicePort.retrieveAll;
...
public class TestRetrieveAll extends BaseTest{
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods="testRetrieveAll")
