...
public class TestValidateBooking extends BaseTest{
	...
	public void missingFacilityId(){
		TestReporter.logStep("Validate a Event Dining Booking - Missing Facility Id");
	...
	public void invalidFacilityId_Integer(){
		String facilityId= "-1";
		TestReporter.logStep("Validate a Event Dining Booking - Invalid Facility Id_Integer");
	...
	public void expiredServiceStartDate(){
		TestReporter.logStep("Validate aShow Event Dining Booking - Expired Service Start Date");
	...
	public void bookDateBeyond180Days(){
		TestReporter.logStep("Validate a Event Dining Booking - Book Date Beyond 180 Days");
		ValidateBooking validate = setupValidateBookingInstance(book.getRequestFacilityId(), book.getRequestProductId(), Randomness.generateCurrentXMLDatetime(181), book.getRequestServicePeriodId());
		TestReporter.assertEquals(validate.getStopReservation(),"true", "The 'Stop Reservation' value ["+validate.getStopReservation()+"] was not 'true' as expected.");
	...
	private void logItems(ValidateBooking validate){
		...
		logValidItems.addItem("EventDiningServiceIF", "validateBooking", false);
