...
import com.disney.api.soapServices.accommodationSalesServicePort.operations.SearchForLinking;
...
public class TestSearchForLinking {
	...
	@Test(groups={"api", "regression", "accommodation", "accommodationSalesService", "SearchForLinking"})
