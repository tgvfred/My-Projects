...
import com.disney.api.soapServices.tpsoModule.travelPlanSalesOrderServiceV1.operations.RetrieveDetailsBySalesOrderId;
import com.disney.utils.Randomness;
import com.disney.utils.Regex;
import com.disney.utils.TestReporter;
import com.disney.utils.dataFactory.guestFactory.HouseHold;

public class TestRetrieveDetailsBySalesOrderId {
	...
	private RetrieveDetailsBySalesOrderId retrieve;
	...
	public void setup(String environment) {
		...
		salesOrderId = create.getSalesOrderIdId();
	}
	
	@Test(groups = {"api", "regression", "tpso", "travelPlanSalesOrderServiceV1"})
	public void testRetrieveDetailsBySalesOrderId(){
		retrieve = new RetrieveDetailsBySalesOrderId(environment, "Main");
		retrieve.setSalesOrderId(salesOrderId);
