...
public class TestModify {
	...
	public void testModify(String Scenario, String SignInLocation,
		...
		if(iteration < maxIterations){
			if (ServiceStyle.equalsIgnoreCase("TableService")) {
				...
				TP_ID.set(book.get().getTravelPlanId());
	...
	private void modifyRes(){
		...
		modify.get().setPrimaryGuestGuestId(retrieve.get().getGuestId());
		modify.get().setPrimaryGuestPartyId(retrieve.get().getPartyId());
		...
		TestReporter.assertEquals(modify.get().getStatus(), "SUCCESS", "The modification status ["+modify.get().getStatus()+"] was not 'SUCCESS' as expected.");
	}
}