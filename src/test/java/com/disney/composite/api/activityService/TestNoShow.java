...
public class TestNoShow {
	...
	public void testNoShow(String Scenario, String Role,
	...
	private void updateToArrived(){
		...
		TestReporter.logAPI(!noshow.get().getResponseStatusCode().equals("200"), "An error occurred updating the reservation to 'NoShow.'", noshow.get());
		TestReporter.assertTrue(new Regex().match("[0-9]+", noshow.get().getCancellationNumber()), "The cancellation confirmation number ["+noshow.get().getCancellationNumber()+"] was not numeric as expected.");
	}
