package com.disney.composite.api.partyModule.partyV3.filterPartyIDsByLastName;
...
import com.disney.api.soapServices.partyModule.partyV3.operations.CreateAndRetrieveParty;
import com.disney.api.soapServices.partyModule.partyV3.operations.FilterPartyIDsByLastName;
...
public class TestFilterPartyIDsByLastName extends BaseTest{
	...
	public void testFilterPartyIDsByLastName_MultipleParties_NoResults(){
		...
		guest2.sendToApi(this.environment, true);
