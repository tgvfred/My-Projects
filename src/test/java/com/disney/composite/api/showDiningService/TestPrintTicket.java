...
public class TestPrintTicket {
	...
	public void testPrintTicket(String Scenario, String SignInLocation,
		...
		if (RunTest.equalsIgnoreCase("true")) {
			if(!ServiceStyle.equalsIgnoreCase("TableService")){
				...
				TestReporter.assertEquals(print.get().getStatus(), "SUCCESS", "The status ["+print.get().getStatus()+"] was not 'SUCCESS' as expected.");
			}
		}
	}
}
