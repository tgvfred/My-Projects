...
public class TestRetrieveAll extends BaseTest{
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_Allergies(){		
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_BookingStatusValues(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_CancelReasons(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_ChangeReasons(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_CommunicationChannels(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_GuestRequests(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_MassCancelReasons(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_ReprintReasons(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_Roles(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_SalesChannels(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_SpecialEvents(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_SpecialNeeds(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_TaxExemptTypes(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_CommentTypes(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_InventoryOverideReasons(){
	...
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void retrieveAll_AlaCarteCancelReasons(){
		...
		reportValues("Celebrations", retrieveAll.getNumberOfAlaCarteCancelReasons(), retrieveAll.getAlaCarteCancelReasonsCodes());
		...
		reportValues("Celebrations", retrieveAll.getNumberOfAlaCarteCancelReasons(), retrieveAll.getAlaCarteCancelReasonsDescriptions());
		...
		reportValues("Celebrations", retrieveAll.getNumberOfAlaCarteCancelReasons(), retrieveAll.getAlaCarteCancelReasonsIds());
	}
	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"}, dependsOnMethods = "testRetrieveAll")public void validateLogs(){
