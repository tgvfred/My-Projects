...
public class TestRetrieveDiningReservations extends BaseTest{
	...
	public void testRetrieveDiningReservations_recordsReturned(){
		TestReporter.logScenario("Records Returned");
		...
		for(String facilityId : facilityIds){
			...
			if(retrieve.areReservationsReturned()) 
				break;
		}
		...
		TestReporter.assertTrue(retrieve.areReservationsReturned(), "No reservations were returned.");
	}
	
//	@Test(groups = {"api", "regression", "dining", "scheduledEventsServicePort"})
//	public void testRetrieveDiningReservations_noRecordsReturned(){
//		TestReporter.logScenario("No Records Returned");
//		RetrieveDiningReservations retrieve = new RetrieveDiningReservations(environment, "Main");
//		retrieve.setFacilityId("1");
//		retrieve.sendRequest();
//		TestReporter.logAPI(!retrieve.getResponseStatusCode().equals("200"), "An error occurred retrieving dining reservations. " + retrieve.getFaultString(), retrieve);
//		TestReporter.assertFalse(retrieve.areReservationsReturned(), "No reservations were returned.");		
//	}
}