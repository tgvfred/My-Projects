...
public class TestReplaceAllForTravelPlanSegment_ModifyWithMultiRoomDetails_noTcg extends AccommodationBaseTest {
    ...
    private void validations() {
        ...
        validations.validateModificationBackendMultiAccomm(6, "Booked", "", getArrivalDate(), getDepartureDate(), "NULL", "NULL",
        ...
        // validations.validateTPV3(getBook().getTravelPlanId(), "Booked", getArrivalDate(), getDepartureDate(), getHouseHold().primaryGuest(), 3, 3, "N",
