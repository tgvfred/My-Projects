...
public class TestReinstate_nullSalesChannel_Negative extends AccommodationBaseTest {
    ...
    public void Test_Reinstate_nullSalesChannel_Negative() {
        ...
        reinstate.setSalesChannel(BaseSoapCommands.REMOVE_NODE.toString());
        reinstate.sendRequest();

        String faultstring = "Sales Channel is required : null";

        validateApplicationError(reinstate, AccommodationErrorCode.SALES_CHANNEL_REQUIRED);
