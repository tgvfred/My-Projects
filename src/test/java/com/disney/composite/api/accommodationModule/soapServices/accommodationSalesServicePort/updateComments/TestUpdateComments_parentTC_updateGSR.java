...
public class TestUpdateComments_parentTC_updateGSR extends AccommodationBaseTest{
String commentId = Randomness.randomNumber(9);
...
String parentId = "";
	...
	public void testUpdateComments_parentTC_updateGSR() {
		...
		TestReporter.softAssertFalse(update.getSendToGSR().equals(sendToGSR), "Verify that the GSR node [" + update.getSendToGSR() + "] has been changed from the old value [" + sendToGSR + "]");
