...
public class TestModify_UsingMultipleProfilesWithOneIDOneCode extends AccommodationBaseTest {
    ...
    public void setup(String environment) {
        ...
        profileData.put(PROFILE_CODE, rs.getValue("PRFL_VAL_CD"));
        ...
        getBook().setRequestNodeValueByXPath("/Envelope/Body/replaceAllForTravelPlanSegment/request/roomDetails/roomReservationDetail/profiles[2]/code", BaseSoapCommands.REMOVE_NODE.toString());
    ...
    public void testModify_UsingMultipleProfilesWithOneIDOneCode() {
