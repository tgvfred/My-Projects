...
public class TestModify_ModifyWithFreezeId extends AccommodationBaseTest {
    ...
    public void setup(String environment) {
        ...
        setTcgId(tcgId);
        setTcId(tcId);
        setBypassFreeze(false);
    }

    @Test(groups = { "api", "regression", "accommodation", "accommodationSalesService", "modify" })
    public void testModify_ModifyWithFreezeId() {
        Modify modify = new Modify(getBook());
        modify.setRequestNodeValueByXPath("//byPassFreeze", "false");
        modify.setRequestNodeValueByXPath("//modify/request/roomDetail/overideFreeze", "false");
        modify.setRequestNodeValueByXPathAndAddNode("/Envelope/Body/modify/request/roomDetail/freezeId", freezeInventory());
        modify.sendRequest();
        ...
        if (Environment.isSpecialEnvironment(environment)) {
            ...
            clone.setRequestNodeValueByXPathAndAddNode("/Envelope/Body/modify/request/roomDetail/freezeId", freezeInventory());
            clone.sendRequest();
            ...
            clone.addExcludedBaselineXpathValidations("/Envelope/Body/modifyResponse/modifyResponse/roomDetails/freezeId");
            clone.addExcludedXpathValidations("/Envelope/Body/modifyResponse/modifyResponse/roomDetails/freezeId");
