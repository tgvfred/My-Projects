...
public class TestUnshareAccommodations_NoAccomFound_Negative extends AccommodationBaseTest {
    ...
    public void testUnshareAccommodations_NoAccomFound_Negative() {
        ...
        unshare.setTcgId("1", "-34");
        unshare.setTcId("1", "-54");
        ...
        unshare.setTcgId("2", "-34");
        unshare.setTcId("2", "-54");
