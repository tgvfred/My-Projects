...
public class TestSearchResortReservationsByGuest_roomOnly_multipleGuests extends AccommodationBaseTest {
    ...
    public void testSearchResortReservationsByGuest_roomOnly_multipleGuests() {
        ...
        // Validate multiple partyRoles nodes are returned
        if (numberOfPartyRoles > 1) {

            TestReporter.assertTrue(numberOfPartyRoles > 1, "There are [" + numberOfPartyRoles + "] party roles in the Response.");
        } else {

            TestReporter.assertTrue(numberOfPartyRoles <= 1, "There was only [" + numberOfPartyRoles + "] party roles.");
        }
