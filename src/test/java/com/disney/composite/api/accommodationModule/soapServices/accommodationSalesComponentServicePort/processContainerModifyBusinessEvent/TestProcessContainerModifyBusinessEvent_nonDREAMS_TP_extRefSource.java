...
public class TestProcessContainerModifyBusinessEvent_nonDREAMS_TP_extRefSource extends AccommodationBaseTest {
    ...
    public void testProcessContainerModifyBusinessEvent_nonDREAMS_TP_extRefSource() {
        ...
        String chargeGroupStatusSql = "select c.CHRG_GRP_STS_NM"
                ...
                + " left outer join folio.CHRG_GRP_EXTNL_REF b on a.EXTNL_REF_ID = b.EXTNL_REF_ID"
                + " left outer join folio.CHRG_GRP c on b.CHRG_GRP_ID = c.CHRG_GRP_ID"
                + " where a.EXTNL_REF_VAL in ('" + "472121534976" + "','" + tp + "', '2357625723562356')";
        ...
        String rimSql = "select *"
                ...
                + " where a.tc_grp_nb = 2357625723562356";
        ...
        TestReporter.assertTrue(rs.getValue("TRVL_STS_NM TP_STATUS") != "REINSTATE", "The reservation is [" + rs.getValue("TRVL_STS_NM TP_STATUS") + "]");
        ...
        TestReporter.assertTrue(rs3.getValue("TPS_CNCL_NB CANCEL_NUMBER") != "0", "The cancellation number is [" + rs.getValue("TPS_CNCL_NB CANCEL_NUMBER") + "]");
