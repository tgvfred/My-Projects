...
public class TestReplaceAllForTravelPlanSegment_ModifyWDTCWithRoomOnly extends AccommodationBaseTest {
    ...
    public void testReplaceAllForTravelPlanSegment_ModifyWDTCWithRoomOnly() {
        ...
        validations.validateModificationBackend(2, "Booked", "", getArrivalDate(), getDepartureDate(), "RESERVATION", extRefNum,
                getBook().getTravelPlanId(), getBook().getTravelPlanSegmentId(), getBook().getTravelComponentGroupingId(), "NULL");
        ...
        validations.verifyRIMGuaranteeStatus(this, "N", "Y");
        ...
        // validations.validateTPV3(getBook().getTravelPlanId(), "Booked", getArrivalDate(), getDepartureDate(), tpPtyId, getHouseHold().primaryGuest(), 1, 1,
