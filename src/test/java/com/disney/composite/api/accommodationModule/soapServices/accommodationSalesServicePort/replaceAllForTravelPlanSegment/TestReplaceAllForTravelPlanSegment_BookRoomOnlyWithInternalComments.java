...
public class TestReplaceAllForTravelPlanSegment_BookRoomOnlyWithInternalComments extends AccommodationBaseTest {
    ...
    public void testReplaceAllForTravelPlanSegment_BookRoomOnlyWithInternalComments() {
        bookReservation();
