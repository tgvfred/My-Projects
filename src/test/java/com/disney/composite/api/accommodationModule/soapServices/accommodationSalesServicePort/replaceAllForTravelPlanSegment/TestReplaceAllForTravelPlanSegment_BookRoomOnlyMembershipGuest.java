...
public class TestReplaceAllForTravelPlanSegment_BookRoomOnlyMembershipGuest extends AccommodationBaseTest {
    ...
    public void testReplaceAllForTravelPlanSegment_BookRoomOnlyMembershipGuest() {
        bookReservation();
