...
public class TestReplaceAllForTravelPlanSegment_BookWithMultiRoomDifferentFacilities extends AccommodationBaseTest {
    String tcg1 = null;
    String tcg2 = null;
    ...
    public void setup(String environment) {
        ...
        do {
            setValues();
        } while (facID.equals(getFacilityId()));
    ...
    public void testReplaceAllForTravelPlanSegment_BookWithMultiRoomDifferentFacilties() {
        getBook().sendRequest();
