...
public class TestModify_CheckInGrandCalifornianWithRoomNumber extends BookDVCCashHelper {

    private String tpPtyId = null;
    private String tpId = null;
    private String roomNumber = "2509";
    ...
    public void testModify_CheckInGrandCalifornianWithRoomNumber() {
        ...
        validations.verifyRIMRoomNumber(modify.getTravelPlanId(), roomNumber, true);
        ;
        // Validate guest
        ...
        // Old vs new not valid since room assigned
