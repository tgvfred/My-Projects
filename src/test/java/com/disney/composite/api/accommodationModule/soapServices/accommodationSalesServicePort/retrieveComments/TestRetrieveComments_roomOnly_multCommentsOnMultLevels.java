...
import com.disney.api.soapServices.folioModule.chargeGroup.operations.GetExternalReferencePairs;
...
public class TestRetrieveComments_roomOnly_multCommentsOnMultLevels extends AccommodationBaseTest {
    ...
    public void testCreateComments_parentTC() {
        ...
        createTPS.setParentIds(getBook().getTravelPlanId());        
        createTPS.setCommentText(commentText);                
        createTPS.sendRequest();
        
        
        TestReporter.logAPI(!createTPS.getResponseStatusCode().equals("200"), "An error occurred submitting TP comment", createTPS);
