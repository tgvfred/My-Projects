...
public class TestModify_ModifyTicketsSelectableTrueToFalse extends AccommodationBaseTest {
    ...
    public void setup(String environment) {
        ...
        bookReservation();
        getBook().setRequestNodeValueByXPath("/Envelope/Body/replaceAllForTravelPlanSegment/request/roomDetails/ticketDetails", BaseSoapCommands.ADD_NODE.commandAppend("selectable"));
        getBook().setRequestNodeValueByXPath("/Envelope/Body/replaceAllForTravelPlanSegment/request/roomDetails/ticketDetails/selectable", "true");
        getBook().sendRequest();
        ...
        retrieveReservation(getBook());
        bookReservation();
        getBook().setRequestNodeValueByXPath("/Envelope/Body/replaceAllForTravelPlanSegment/request/roomDetails/ticketDetails", BaseSoapCommands.ADD_NODE.commandAppend("selectable"));
        getBook().setRequestNodeValueByXPath("/Envelope/Body/replaceAllForTravelPlanSegment/request/roomDetails/ticketDetails/selectable", "false");
        getBook().setRequestNodeValueByXPath("/Envelope/Body/replaceAllForTravelPlanSegment/request/roomDetails/ticketDetails/guestReference/guest/guestId", getRetrieve().getGuestId());
    ...
    public void testModify_ModifyTicketsSelectableTrueToFalse() {
        ...
        String admissionComponentId = validations.validateAdmissionComponentAdded(modify.getTravelComponentGroupingId());
        String ticketComponentPrice = validations.validateAdmissionComponentDetails(admissionComponentId, getTicketsHelper().getCode());
        validations.validateAdmissionComponentPrice(modify.getTravelPlanId(), ticketComponentPrice);
