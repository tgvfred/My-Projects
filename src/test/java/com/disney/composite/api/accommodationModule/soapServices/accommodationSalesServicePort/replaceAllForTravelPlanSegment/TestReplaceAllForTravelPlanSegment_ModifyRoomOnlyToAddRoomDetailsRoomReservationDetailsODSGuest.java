...
public class TestReplaceAllForTravelPlanSegment_ModifyRoomOnlyToAddRoomDetailsRoomReservationDetailsODSGuest extends AccommodationBaseTest {
    ...
    public void testReplaceAllForTravelPlanSegment_ModifyRoomOnlyToAddRoomDetailsRoomReservationDetailsODSGuest() {
        setSendRequest(false);
        setAddPrimaryGuestODS(true);
        bookReservation();
