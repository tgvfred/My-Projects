...
public class TestRetrieve_guestWithMultPhones extends AccommodationBaseTest {
    ...
    public void setup(String environment) {
        ...
        bookReservation("ROTwoPhoneDetails");

    }

    @Test(groups = { "api", "regression", "accommodation", "accommodationSalesService", "retrieve" })
    public void testRetrieve_guestWithMultPhones() {
