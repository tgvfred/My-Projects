...
public class TestUpdateComments_parentTC_updateConfidential extends AccommodationBaseTest {
    ...
    public void testUpdateComments_parentTC_updateConfidential() {
        ...
        TestReporter.setAssertFailed(false);
        TestReporter.logAPI(!update.getResponseStatusCode().equals("200"), "An error occurred getting options by filter", update);
        TestReporter.softAssertFalse(update.getConfidential().equals(confidential), "Verify that the confidential node [" + update.getConfidential() + "] has been changed from the old value [" + confidential + "]");
