...
public class TestSearchResortReservationsByGuest_roomOnly_agencyIataNumber_LastNameOnly extends AccommodationBaseTest {
    ...
    public void setup(String environment) {
        ...
        System.out.print(getBook().getResponse());
    }

    @Test(groups = { "api", "regression", "accommodation", "accommodationSalesService", "searchResortReservationsByGuest", "smoke" })
    public void testSearchResortReservationsByGuest_roomOnly_agencyIataNumber_LastNameOnly() {

        Guest guest;
        guest = getHouseHold().primaryGuest();
        TestReporter.logScenario("Test - SearchResortReservationsByGuest - Room Only -agencyIataNumber- LastNameOnly");
        ...
        searchRRByGuest.setAgencyIataNumber("99999998");
        ...
        System.out.println(searchRRByGuest.getRequest());
        ...
        // If number of results is > 150, the service should throw an error.
        if (numberOfResortReservations > 150) {
            ...
            // If < 150, verify that the booked reservation is found in the response Validate the data for the prereq reservation
