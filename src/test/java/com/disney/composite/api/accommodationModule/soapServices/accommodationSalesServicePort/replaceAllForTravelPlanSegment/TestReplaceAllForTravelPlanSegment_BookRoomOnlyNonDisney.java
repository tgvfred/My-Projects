...
public class TestReplaceAllForTravelPlanSegment_BookRoomOnlyNonDisney extends AccommodationBaseTest {
    ...
    public void testReplaceAllForTravelPlanSegment_BookRoomOnlyNonDisney() {
        bookReservation();
        ...
        validations.verifyRIMGuaranteeStatus(this, "N", "N");
