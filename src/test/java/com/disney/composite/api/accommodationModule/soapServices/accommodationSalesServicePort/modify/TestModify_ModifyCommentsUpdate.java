...
public class TestModify_ModifyCommentsUpdate extends AccommodationBaseTest {
    ...
    public void setup(String environment) {
        ...
        setTcgId(tcgId);
        setTcId(tcId);
        getBook().setRequestNodeValueByXPath("/Envelope/Body/replaceAllForTravelPlanSegment/request/internalComments/commentText", "Blah");
        getCommentsData().put(COMMENT_TEXT, "Blah");
    }

    @Test(groups = { "api", "regression", "accommodation", "accommodationSalesService", "modify" })
    public void testModify_ModifyCommentsAdd() {
        ...
        validations.validateComments(modify.getTravelPlanId(), getCommentsData(), "Internal", "N", "N", 1, "TravelPlanSegmentComment", "NULL");
