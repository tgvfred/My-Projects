...
import static com.disney.api.soapServices.accommodationModule.applicationError.LiloResmErrorCode.NO_TRAVEL_PLAN_DATA_FOUND;
import static com.disney.api.soapServices.accommodationModule.applicationError.LiloResmErrorCode.SEARCH_CRITERIA_INVALID;
...
public class TestRetrieveResortReservations_Negative extends BaseTest {
    ...
    public void testRetrieveResortReservations_NullReservationNumber() {
        ...
        sendRequestAndValidateApplicationError(BaseSoapCommands.REMOVE_NODE.toString(), SEARCH_CRITERIA_INVALID);
    }
