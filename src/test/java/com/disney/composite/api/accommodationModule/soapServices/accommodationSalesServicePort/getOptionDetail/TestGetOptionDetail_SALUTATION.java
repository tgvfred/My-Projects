...
public class TestGetOptionDetail_SALUTATION extends BaseTest {
    ...
    public void testGetOptionDetail_SALUATION(String key, String value) {

        // System.out.println(key);
        // System.out.println(value);

        GetOptionDetail getOptionDetail = new GetOptionDetail(environment);
        getOptionDetail.setAccommodationSalesOptionsEnum("SALUTATION");
    ...
    public Object[][] OptionKV() {
        ...
        getOptions.setOptionType("SALUTATION");
