...
public class TestModify_ModifyCommunicationChannel extends AccommodationBaseTest {
    ...
    public void setup(String environment) {
        ...
        bookReservation();
        getBook().setSalesChannel("Travel Agent");
    ...
    public void testModify_ModifyCommunicationChannel() {
