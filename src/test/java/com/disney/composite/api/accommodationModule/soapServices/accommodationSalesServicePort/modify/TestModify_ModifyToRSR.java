...
public class TestModify_ModifyToRSR extends AccommodationBaseTest {
    ...
    public void testModify_ModifyToRSR() {
        ...
        validations.verifyPackageTravelComponent(tcgId, "Y", "Y", "N");
