...
public class TestModify_ModifyGuestRemoveGuest extends AccommodationBaseTest {
    ...
    public void setup(String environment) {
        ...
        setTcgId(tcgId);
        setTcId(tcId);
        getBook().setRequestNodeValueByXPath("/Envelope/Body/replaceAllForTravelPlanSegment/request/roomDetails/roomReservationDetail/guestReferenceDetails[2]", BaseSoapCommands.REMOVE_NODE.toString());
    }

    @Test(groups = { "api", "regression", "accommodation", "accommodationSalesService", "modify" })
    public void testModify_ModifyGuestRemoveGuest() {
