...
public class TestReplaceAllForTravelPlanSegment_modifyDatesOutsideOfCurrentTpsPeriod extends AccommodationBaseTest {
    ...
    private int originalDaysOut = 4;
    private int originalNights = 2;
    private int roomModDaysOut = 10;
    private int roomModNights = 2;
    ...
    public void setup(String environment) {
        ...
        setDaysOut(originalDaysOut);
        setNights(originalNights);
    ...
    public void testReplaceAllForTravelPlanSegment_modifyDatesOutsideOfCurrentTpsPeriod() {
        ...
        validations.validateModificationBackend(2, "Booked", "", Randomness.generateCurrentXMLDate(roomModDaysOut), Randomness.generateCurrentXMLDate(roomModDaysOut + roomModNights), "NULL", "NULL",
