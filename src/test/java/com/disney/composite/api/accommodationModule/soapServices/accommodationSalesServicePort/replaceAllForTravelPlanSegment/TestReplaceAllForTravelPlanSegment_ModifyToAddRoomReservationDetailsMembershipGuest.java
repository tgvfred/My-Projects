...
public class TestReplaceAllForTravelPlanSegment_ModifyToAddRoomReservationDetailsMembershipGuest extends AccommodationBaseTest {
    ...
    public void testReplaceAllForTravelPlanSegment_ModifyToAddRoomReservationDetailsMembershipGuest() {
        ...
        getMembershipData().put("TP", getBook().getTravelPlanId());
        validations.verifyGuestMembership(getMembershipData());
