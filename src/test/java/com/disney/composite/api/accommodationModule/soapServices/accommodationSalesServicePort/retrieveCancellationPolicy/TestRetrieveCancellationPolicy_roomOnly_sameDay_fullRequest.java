...
public class TestRetrieveCancellationPolicy_roomOnly_sameDay_fullRequest extends AccommodationBaseTest {
    ...
    public void testRetrieveCancellationPolicy_roomOnly_sameDay_fullRequest() {
        ...
        // Verify that cancel fee is NOT 0.0
        ...
        TestReporter.assertTrue(!retrieve.getFeeWaived().equals("null"), "Verify that the fee waived node [" + retrieve.getFeeWaived() + "] is not null");
