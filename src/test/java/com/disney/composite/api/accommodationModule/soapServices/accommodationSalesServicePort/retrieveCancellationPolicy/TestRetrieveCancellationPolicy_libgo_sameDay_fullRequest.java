...
public class TestRetrieveCancellationPolicy_libgo_sameDay_fullRequest extends AccommodationBaseTest {
    ...
    public void testRetrieveCancellationPolicy_libgo_sameDay_fullRequest() {
        ...
        TestReporter.assertTrue(retrieve.getFeeWaived().equals("false"), "Verify that the fee waived node [" + retrieve.getFeeWaived() + "] is false");
