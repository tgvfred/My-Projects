...
public class TestModify_ModifyGuestAddAdult extends AccommodationBaseTest {
    ...
    public void testModify_ModifyAddGuestAdult() {
        ...
        validations.verifyRIMPartyMIx(modify.getTravelPlanId(), "2", "0", true);
