...
public class TestReplaceAllForTravelPlanSegment_ModifyRoomOnlyToAddRoomDetailsRoomReservationDetailsMultipleGuests extends AccommodationBaseTest {
    ...
    public void testReplaceAllForTravelPlanSegment_ModifyRoomOnlyToAddRoomDetailsRoomReservationDetailsMultipleGuests() {
        setAddNewGuest(true);
        bookReservation();
