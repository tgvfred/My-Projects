...
public class TestReplaceAllForTravelPlanSegment_BookMYWPlusDine extends AccommodationBaseTest {
    ...
    public void testReplaceAllForTravelPlanSegment_BookMYWPlusDine() {
        bookReservation();
        ...
        validations.validateModificationBackend(17, "Booked", "", getArrivalDate(), getDepartureDate(), "RESERVATION", getExternalRefNumber(),
        ...
        validations.verifyNumberOfChargesByStatus("UnEarned", 11, getBook().getTravelPlanId());
        validations.verifyChargeDetail(15, getBook().getTravelPlanId());
