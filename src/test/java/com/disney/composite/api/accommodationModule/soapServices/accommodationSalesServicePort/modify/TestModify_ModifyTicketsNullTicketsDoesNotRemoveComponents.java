...
public class TestModify_ModifyTicketsNullTicketsDoesNotRemoveComponents extends AccommodationBaseTest {
    ...
    public void setup(String environment) {
        ...
        bookReservation();
        getBook().setRequestNodeValueByXPath("/Envelope/Body/replaceAllForTravelPlanSegment/request/roomDetails/ticketDetails", BaseSoapCommands.REMOVE_NODE.toString());
    ...
    public void testModify_ModifyTicketsNullTicketsDoesNotRemoveComponents() {
