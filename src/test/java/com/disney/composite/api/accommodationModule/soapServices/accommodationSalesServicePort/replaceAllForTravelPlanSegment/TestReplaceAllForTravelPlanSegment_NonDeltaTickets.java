...
public class TestReplaceAllForTravelPlanSegment_NonDeltaTickets extends AccommodationBaseTest {
	...
	public void testReplaceAllForTravelPlanSegment_NonDeltaTickets() {
		...
		TestReporter.assertTrue(
				bookPackage.getNumberOfResponseNodesByXPath(
						"/Envelope/Body/bookPackageSelectableTicketsResponse/selectableTicketResponse/tickets/ticket/ticketValidityPeriod/startDate") == 0,
				"No Validity Period Start Date Node was found in the Response.");
		TestReporter.assertTrue(
				bookPackage.getNumberOfResponseNodesByXPath(
						"/Envelope/Body/bookPackageSelectableTicketsResponse/selectableTicketResponse/tickets/ticket/ticketValidityPeriod/endDate") == 0,
