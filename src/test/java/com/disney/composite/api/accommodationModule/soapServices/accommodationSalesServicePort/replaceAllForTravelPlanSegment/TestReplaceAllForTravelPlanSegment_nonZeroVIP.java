...
public class TestReplaceAllForTravelPlanSegment_nonZeroVIP extends AccommodationBaseTest {
    ...
    public void testReplaceAllForTravelPlanSegment_nonZeroVIP() {
        bookReservation();
        ...
        validations.validateVIP(getBook().getTravelPlanId(), getVipLevel());
