...
public class TestOverrideAccommodationRates_TA extends AccommodationBaseTest {
    ...
    public void testOverrideAccommodationRates_TA() {
        ...
        for (int o = 0; o <= rs6.getRowCount() - 1; o++) {
            ...
            TestReporter.assertTrue(!allPairs5.keySet().toArray()[o].equals(allPairs6.keySet().toArray()[o]), "In row [" + o + "] the Folio item id [" + allPairs5.keySet().toArray()[o] + "] has been updated to [" + allPairs6.keySet().toArray()[o] + "]. ");
        }
