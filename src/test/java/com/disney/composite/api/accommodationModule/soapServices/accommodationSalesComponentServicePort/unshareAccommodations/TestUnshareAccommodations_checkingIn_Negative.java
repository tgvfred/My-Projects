...
public class TestUnshareAccommodations_checkingIn_Negative extends AccommodationBaseTest {
    ...
    public void testUnshare_checkingIn_Negative() {
        ...
        CheckInHelper checkingIn = new CheckInHelper(environment, firstBooking);
        checkingIn.checkingIn(getLocationId(), getDaysOut(), getNights(), getFacilityId());
        checkingIn = new CheckInHelper(environment, secondBooking);
        checkingIn.checkingIn(getLocationId(), getDaysOut(), getNights(), getFacilityId());
