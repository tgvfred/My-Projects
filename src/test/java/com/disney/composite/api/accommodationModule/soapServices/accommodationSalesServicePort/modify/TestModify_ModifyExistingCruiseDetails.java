...
public class TestModify_ModifyExistingCruiseDetails extends AccommodationBaseTest {
    ...
    public void testModify_ModifyExistingCruiseDetails() {
        ...
        validations.verifyDclGuestIdCreated(modify.getTravelPlanId());
