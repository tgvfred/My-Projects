...
public class TestModify_NullLocationId extends AccommodationBaseTest {
    ...
    public void setup(String environment) {
        ...
        getBook().setLocationId(BaseSoapCommands.REMOVE_NODE.toString());
        setTpId(tpId);
        setTpsId(tpsId);
        setTcgId(tcgId);
        setTcId(tcId);
    ...
    public void testModify_NullLocationId() {
        ...
        TestReporter.assertTrue(modify.getResponseNodeValueByXPath("/Envelope/Body/modifyResponse/modifyResponse/roomDetails/locationId").equals("1"), "Validate location ID returned in Response was [ 1 ] as expected ");
