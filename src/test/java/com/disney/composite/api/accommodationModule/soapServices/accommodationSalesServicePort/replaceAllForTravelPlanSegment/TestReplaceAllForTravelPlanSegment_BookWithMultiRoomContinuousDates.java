...
public class TestReplaceAllForTravelPlanSegment_BookWithMultiRoomContinuousDates extends AccommodationBaseTest {
    String tcg1 = null;
    String tcg2 = null;
    ...
    public void testReplaceAllForTravelPlanSegment_BookWithMultiRoomContinuousDates() {
        bookReservation();
        setArrivalDate(0);
        getBook().setAreaPeriodStartDate(Randomness.generateCurrentXMLDate(0));
        getBook().setRoomDetails_ResortPeriodStartDate(Randomness.generateCurrentXMLDate(0));
        getBook().setRoomDetails_ResortPeriodEndDate(Randomness.generateCurrentXMLDate(4));
        getBook().sendRequest();
    ...
    private void validations() {
        ...
        validations.verifyNumberOfChargesByStatus("UnEarned", 10, getBook().getTravelPlanId());
        validations.verifyChargeDetail(40, getBook().getTravelPlanId());
