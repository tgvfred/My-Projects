...
public class TestRetrieveTravelPlanMediaCustomization_xbmsResort_twoGuests_bothFalse extends AccommodationBaseTest {

    @Test(groups = { "api", "regression", "accommodation", "accommodationSalesService", "retrieveTravelPlanMediaCustomization" })
    public void testRetrieveTravelPlanMediaCustomization_xbmsResort_twoGuests_bothFalse() {
        String facilityId = getFacilityId();
        String resortCode = "1U";
        String locationId = getLocationId();
        String party1Id = getPartyId();
        String party1Type = "false";
        ...
        try {
            retrieve.getResponseNodeValueByXPath("/Envelope/Body/retrieveTravelPlanMediaCustomizationResponse/response/experienceMediaDetails");
