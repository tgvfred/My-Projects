...
public class TestReplaceAllForTravelPlanSegment_BookWithMultiRoomDetails_ModifyOne extends AccommodationBaseTest {
    ...
    public void testReplaceAllForTravelPlanSegment_BookWithMultiRoomDetails_ModifyOne() {
    ...
    private void validations() {
        ...
        Map<String, String> facIds = new HashMap<>();
        String facId = ResortInfo.getFacilityID(ResortColumns.RESORT_CODE, resortCode1);
        facIds.put(facId, facId);
        facId = ResortInfo.getFacilityID(ResortColumns.RESORT_CODE, resortCode2);
        facIds.put(facId, facId);
        validations.validateTPV3(getBook().getTravelPlanId(), "Booked", getArrivalDate(), getDepartureDate(), getHouseHold().primaryGuest(), 2, 2, "N", "NULL", facIds, getAdditionalGuests());
    }
}
