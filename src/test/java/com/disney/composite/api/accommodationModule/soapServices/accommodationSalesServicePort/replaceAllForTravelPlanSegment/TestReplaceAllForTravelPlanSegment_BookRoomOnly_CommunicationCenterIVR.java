...
public class TestReplaceAllForTravelPlanSegment_BookRoomOnly_CommunicationCenterIVR extends AccommodationBaseTest {
    ...
    public void testReplaceAllForTravelPlanSegment_BookRoomOnly_CommunicationCenterIVR() {
        bookReservation();
        getBook().setCommunicationChannel("IVR");
        getBook().sendRequest();
