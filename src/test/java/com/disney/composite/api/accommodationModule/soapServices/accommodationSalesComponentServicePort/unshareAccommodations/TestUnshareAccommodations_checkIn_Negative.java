...
public class TestUnshareAccommodations_checkIn_Negative extends AccommodationBaseTest {
    ...
    public void testUnshareAccommodations_checkIn_Negative() {
        String faultString = " Accommodation should be in Booked status to be UnShared";
        ...
        checkIn.setTravelComponentGroupingId(firstBooking.getTravelComponentGroupingId());
        ...
        checkIn.setTravelComponentGroupingId(secondBooking.getTravelComponentGroupingId());
        checkIn.sendRequest();
        TestReporter.logAPI(!share.getResponseStatusCode().equals("200"), "Verify that no error occurred while checking in a reservation " + share.getFaultString(), share);
