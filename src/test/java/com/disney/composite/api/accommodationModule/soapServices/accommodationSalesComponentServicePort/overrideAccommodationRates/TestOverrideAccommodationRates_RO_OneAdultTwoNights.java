...
public class TestOverrideAccommodationRates_RO_OneAdultTwoNights extends AccommodationBaseTest {
    ...
    public void testOverrideAccommodationRates_RO_OneAdultTwoNights() {
        ...
        //
        OverrideAccommodationRatesRequest oar = new OverrideAccommodationRatesRequest(Environment.getBaseEnvironmentName(environment), "twoNights");
         ...
         */
        // oar.setRackRateDate2(getArrivalDate());
        oar.sendRequest();
