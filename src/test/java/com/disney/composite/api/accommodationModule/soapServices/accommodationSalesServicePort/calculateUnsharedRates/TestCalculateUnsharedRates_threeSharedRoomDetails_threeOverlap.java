...
public class TestCalculateUnsharedRates_threeSharedRoomDetails_threeOverlap extends AccommodationBaseTest {
    ...
    public void validateUnsharedAccommodation() {
        ...
        TestReporter.softAssertEquals(calculate.getShareChainUnSharedRoomDetailsStartDate("1", "1"), resortPeriodStartDate, "Verify that the response returns the start date [" + calculate.getShareChainUnSharedRoomDetailsStartDate("1", "1") + "] that which is expected [" + resortPeriodStartDate + "].");
        TestReporter.softAssertEquals(calculate.getShareChainUnSharedRoomDetailsEndDate("1", "1"), resortPeriodEndDate, "Verify that the response returns the end date [" + calculate.getShareChainUnSharedRoomDetailsEndDate("1", "1") + "] that which is expected [" + resortPeriodEndDate + "].");
