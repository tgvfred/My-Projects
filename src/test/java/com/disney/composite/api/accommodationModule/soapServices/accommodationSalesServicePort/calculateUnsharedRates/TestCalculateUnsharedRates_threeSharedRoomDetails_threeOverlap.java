...
public class TestCalculateUnsharedRates_threeSharedRoomDetails_threeOverlap extends AccommodationBaseTest {
    ...
    public void validateFirstShareChain() {
        ...
        String sharedRoomResortPeriodStartDate = calculate.getRequestNodeValueByXPath("/Envelope/Body/calculateUnsharedRates/request/unSharedChain/shareRoomDetails[1]/unSharedRoomDetail/resortPeriod/startDate");
        String sharedRoomResortPeriodEndDate = calculate.getRequestNodeValueByXPath("/Envelope/Body/calculateUnsharedRates/request/unSharedChain/shareRoomDetails[1]/unSharedRoomDetail/resortPeriod/endDate");
        String TC1 = calculate.getRequestNodeValueByXPath("/Envelope/Body/calculateUnsharedRates/request/unSharedChain/shareRoomDetails[2]/unSharedRoomDetail/travelComponentId");
        String TC2 = calculate.getRequestNodeValueByXPath("/Envelope/Body/calculateUnsharedRates/request/unSharedChain/shareRoomDetails[3]/unSharedRoomDetail/travelComponentId");
        ...
        String TCG2 = calculate.getRequestNodeValueByXPath("/Envelope/Body/calculateUnsharedRates/request/unSharedChain/shareRoomDetails[3]/unSharedRoomDetail/travelComponentGroupingId");
        ...
        String TPS2 = calculate.getRequestNodeValueByXPath("/Envelope/Body/calculateUnsharedRates/request/unSharedChain/shareRoomDetails[3]/travelPlanSegmentId");
        ...
        TestReporter.softAssertEquals(calculate.getShareChainUnSharedRoomDetailsEndDateThreeNoOverlap(), sharedRoomResortPeriodEndDate, "Verify that the response returns the shared room resort period end date [" + calculate.getShareChainUnSharedRoomDetailsEndDateThreeNoOverlap() + "] that which is expected [" + sharedRoomResortPeriodEndDate + "].");

        TestReporter.softAssertEquals(calculate.getShareChainUnSharedRoomDetailsTCIdThreeSharedRoom(), TC1, "Verify that the response returns the TC id [" + calculate.getShareChainUnSharedRoomDetailsTCIdThreeSharedRoom() + "] that which is expected [" + TC1 + "].");
        TestReporter.softAssertEquals(calculate.getShareChainUnSharedRoomDetailsTCId("2", "1"), TC2, "Verify that the response returns the TC id no overlap [" + calculate.getShareChainUnSharedRoomDetailsTCId("2", "1") + "] that which is expected [" + TC2 + "].");
        ...
        TestReporter.softAssertEquals(calculate.getShareChainUnSharedRoomDetailsTCGId("2", "1"), TCG2, "Verify that the response returns the TCG id no overlap [" + calculate.getShareChainUnSharedRoomDetailsTCGId("2", "1") + "] that which is expected [" + TCG2 + "].");
        ...
        TestReporter.softAssertEquals(calculate.getShareChainUnSharedRoomDetailsTPSId("2", "1"), TPS2, "Verify that the response returns the TPS id no overlap [" + calculate.getShareChainUnSharedRoomDetailsTPSId("2", "1") + "] that which is expected [" + TPS2 + "].");
        ...
        TestReporter.softAssertEquals(calculate.getUnsharedRoomDetailsDate("1", "2"), date2, "Verify that the date [" + calculate.getUnsharedRoomDetailsDate("1", "2") + "] that which is expected [" + date2 + "].");
    ...
    public void validateUnsharedAccommodation() {
        ...
        TestReporter.softAssertEquals(calculate.getUnsharedAccommodationUnsharedRoomDetailStartDate().split("T")[0], resortPeriodStartDate, "Verify that the response returns the start date [" + calculate.getShareChainUnSharedRoomDetailsStartDate("1", "1") + "] that which is expected [" + resortPeriodStartDate + "].");
        TestReporter.softAssertEquals(calculate.getUnsharedAccommodationUnsharedRoomDetailEndDate().split("T")[0], resortPeriodEndDate, "Verify that the response returns the end date [" + calculate.getShareChainUnSharedRoomDetailsEndDate("1", "1") + "] that which is expected [" + resortPeriodEndDate + "].");
        ...
        TestReporter.assertTrue(calculate.getUnSharedRoomDetailsBasePrice() != basePrice, "Verify that the response does not return the base price [" + calculate.getUnsharedRoomDetailsBasePrice() + "] that which was passed into the request [" + basePrice + "].");
        TestReporter.assertTrue(calculate.getUnSharedRoomDetailsDate() != date, "Verify that the response does not return the date [" + calculate.getUnsharedRoomDetailsDate() + "] that was passed into the request [" + date + "].");
        TestReporter.assertTrue(calculate.getUnSharedRoomDetailsDayCount() != dayCount, "Verify that the response does not returns the day count [" + calculate.getUnsharedRoomDetailsDayCount() + "] that was passed into the request [" + dayCount + "].");
        ...
        TestReporter.assertTrue(calculate.getUnSharedRoomDetailsNetPrice() != netPrice, "Verify that the response does not return the net price [" + calculate.getUnsharedRoomDetailsNetPrice() + "] that was passed into the request [" + netPrice + "].");
        TestReporter.assertTrue(calculate.getUnSharedRoomDetailsPointsValue() != pointsValue, "Verify that the response does not return the points value [" + calculate.getUnSharedRoomDetailsPointsValue() + "] that was passed into the request [" + pointsValue + "].");
        TestReporter.assertAll();
    }
