...
public class TestReplaceAllForTravelPlanSegment_BookRoomOnlyWithMultInternalComments extends AccommodationBaseTest {
    ...
    public void testReplaceAllForTravelPlanSegment_BookRoomOnlyWithMultInternalComments() {
        setSendRequest(false);
        bookReservation();
        getBook().addInternalComments(1);
