...
public class TestCreateComments_parentTC_noProfile extends AccommodationBaseTest {
    ...
    public void testCreateComments_parentTP_noGSR() {
        ...
        if (create.getSendToGSR().equals("true")) {
            ...
            TestReporter.softAssertEquals(rs.getRowCount(), 0, "Verify that no GSR records werer returned.");
        }
