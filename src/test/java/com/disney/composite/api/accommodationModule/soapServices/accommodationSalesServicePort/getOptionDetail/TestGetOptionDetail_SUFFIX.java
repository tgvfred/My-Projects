...
public class TestGetOptionDetail_SUFFIX extends AccommodationBaseTest {
    ...
    public void testGetOptionDetail_SUFFIX(String key, String value) {
        ...
        getOptionDetail.setAccommodationSalesOptionsEnum("SUFFIX");
    ...
    public Object[][] OptionKV() {
        ...
        getOptions.setOptionType("SUFFIX");
