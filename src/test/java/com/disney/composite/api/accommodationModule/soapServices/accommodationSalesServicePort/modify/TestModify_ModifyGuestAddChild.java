...
public class TestModify_ModifyGuestAddChild extends AccommodationBaseTest {
    ...
    public void testModify_ModifyGuestAddChild() {
        ...
        validations.verifyRIMPartyMIx(modify.getTravelPlanId(), "1", "1", true);

        // Validate guest
        validations.verifyNumberOfTpPartiesByTpId(2, modify.getTravelPlanId());
        ;
