...
public class TestBook {
    ...
    @Test(groups = { "api", "regression", "accommodation", "accommodationSalesService", "book", "example" })
    ...
    @Test(groups = { "api", "regression", "accommodation", "accommodationSalesService", "example" })
