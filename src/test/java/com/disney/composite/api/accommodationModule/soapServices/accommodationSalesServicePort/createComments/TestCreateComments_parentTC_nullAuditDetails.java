...
public class TestCreateComments_parentTC_nullAuditDetails extends AccommodationBaseTest {
    ...
    public void testCreateComments_parentTP_nullAuditDetails() {
        ...
        create.setRequestNodeValueByXPath("/Envelope/Body/createComments/request/commentsInfo/auditDetail", BaseSoapCommands.REMOVE_NODE.toString());
