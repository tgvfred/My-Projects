...
public class TestModify_ModifyWDTCToRoomOnly extends AccommodationBaseTest {
    ...
    public void testModify_ModifyWDTCToRoomOnly() {
        ...
        validations.verifyPackageTravelComponent(tcgId, "N", "N", "Y");
