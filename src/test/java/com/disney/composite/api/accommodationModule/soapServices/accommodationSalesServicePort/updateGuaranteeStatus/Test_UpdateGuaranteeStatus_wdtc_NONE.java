...
public class Test_UpdateGuaranteeStatus_wdtc_NONE extends AccommodationBaseTest {
    ...
    public void testUpdateGuaranteeStatus_wdtc_NONE() {
        ...
        // helper.validation(getBook().getTravelPlanId(), "NONE", "GROUP_GUARANTEED", "N");
        // } else {
        // // Validation when running in Latest
        // helper.validation(getBook().getTravelPlanId(), "DEPOSIT", "DEPOSIT", "N");
        //
        // }
    }
