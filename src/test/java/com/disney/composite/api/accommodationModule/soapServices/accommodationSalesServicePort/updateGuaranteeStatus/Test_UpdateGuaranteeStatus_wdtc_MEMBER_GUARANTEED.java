...
public class Test_UpdateGuaranteeStatus_wdtc_MEMBER_GUARANTEED extends AccommodationBaseTest {
    ...
    public void testUpdateGuaranteeStatus_wdtc_MEMBER_GUARANTEED() {
        ...
        // helper.validation(getBook().getTravelPlanId(), "MEMBER_GUARANTEED", "GROUP_GUARANTEED", "N");
        // } else {
