...
public class TestCreateGroupTeamName_selected_False extends AccommodationBaseTest {
    ...
    public void Test_CreateGroupTeamName_selected_False() {
        ...
        TestReporter.assertEquals(create.getSelected(), "false", "Validate that the selected field returned in the response [" + create.getSelected() + "] is that which is expected [false].");
        validateResponse();
