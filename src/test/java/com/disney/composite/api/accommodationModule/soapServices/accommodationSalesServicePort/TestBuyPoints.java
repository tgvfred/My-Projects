...
import com.disney.api.soapServices.accommodationModule.accommodationSalesServicePort.operations.BuyPoints;
...
public class TestBuyPoints {
    ...
    @Test(groups = { "api", "regression", "accommodation", "accommodationSalesService", "BuyPoints", "example" })
