...
public class TestModify_ModifyRemoveProfile extends AccommodationBaseTest {
    ...
    public void setup(String environment) {
        ...
        getBook().setRequestNodeValueByXPath("/Envelope/Body/replaceAllForTravelPlanSegment/request/roomDetails/roomReservationDetail/profiles", BaseSoapCommands.REMOVE_NODE.toString());
    ...
    public void testModify_ModifyRemoveProfile() {
