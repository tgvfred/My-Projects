...
public class TestRetrieve_guestWithMultAddresses extends AccommodationBaseTest {
    ...
    public void setup(String environment) {
        ...
        bookReservation("ROTwoGuestAddrDetails");

    }

    @Test(groups = { "api", "regression", "accommodation", "accommodationSalesService", "retrieve" })
    public void testRetrieve_guestWithMultAddresses() {
