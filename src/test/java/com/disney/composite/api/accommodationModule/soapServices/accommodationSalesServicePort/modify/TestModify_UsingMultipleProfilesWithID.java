...
public class TestModify_UsingMultipleProfilesWithID extends AccommodationBaseTest {
    ...
    @Test(groups = { "api", "regression", "accommodation", "accommodationSalesService", "modify", "smoke" })
    public void testModify_UsingMultipleProfilesWithID() {
