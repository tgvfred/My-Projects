...
private String environment;
	...
	public void testretrieveGuests_Negative_NullPointer()throws IOException{
		...
		TestReporter.assertTrue(response.getResponse().contains("Unexpected Error occurred : retrieveGuests : java.lang.NullPointerException"),"Charge Account retrieveGuests has folio connectivity and errors correctly with null ointer exception. Positive test is performed from Folio");
	}
	@Test(groups={"api","rest", "regression", "folio", "chargeAccountV2", "retrieveGuests"})
	public void testretrieveGuests_Negative_NoAcctCenter()throws IOException{
		...
		//Add SourceAccountingCenter
		request.setSourceAccountingCenter("");
	...
	public void testretrieveGuests_Negative_NoAuthorization()throws IOException{
		...
		RestResponse response= Rest.folio(environment).chargeAccountService().chargeAccount().retrieveGuests().sendPutRequestWithMissingAuthToken(request);
