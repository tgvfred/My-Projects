package com.disney.composite.folioInterface.payment.makeSplitCardPayment;
...
public class TestFolioInterfacePayment_Resort {
	...
	public void testFolioPayment_Resort(){
		TestReporter.logScenario("Make split payment with a card to Resort reservation.");
		...
		payment.makeSplitCardPayment("Split Payment Amex And MC");
	}
}